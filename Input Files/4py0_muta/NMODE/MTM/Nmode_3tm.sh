...
mpirun -np 8 MMPBSA.py.MPI -O -i Nmode.in \
				...
				-srp ~/mmpbsa_new/4ntj_muta/PSB/70D/Opt/Receptor_gaff/rep1/trunc_6at_muta.4ntj_rec_muta.prmtop \
				-y  ../trunc_Prod.crd \
				-yr ~/mmpbsa_new/4ntj_muta/PSB/70D/Opt/Receptor_gaff/rep1/trunc_6at_muta_Prod.crd \
