...
${pmemd} -O -i 05_Hold.in -p tiq.prmtop -c 04_Hold.rst -o 05_Hold.out -r 05_Hold.rst -x 05_Hold.crd

echo "ending 5mdhold"

echo "starting 6mdprod"

${pmemd} -O -i 06_Prod.in -p tiq.prmtop -c 05_Hold.rst -o 06_Prod.out -r 06_Prod.rst -x 06_Prod.crd
