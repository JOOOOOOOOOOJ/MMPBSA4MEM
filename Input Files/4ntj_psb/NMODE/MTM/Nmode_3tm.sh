...
mpirun -np 8 MMPBSA.py.MPI -O -i Nmode.in \
				...
				-srp ~/mmpbsa_new/4ntj/PSB/70D/Opt/Receptor_gaff/rep1/trunc.4ntj_rec.prmtop \
				-y  ../trunc_Prod.crd \
				-yr ~/mmpbsa_new/4ntj/PSB/70D/Opt/Receptor_gaff/rep1/trunc_Prod.crd \
				-yl ~/mmpbsa_new/4ntj/PSB/70D/Opt/Ligand/rep1/trunc_Prod.crd \
				-eo mtm4ntjpsbnm1.csv \
				-o  mtm4ntjpsbnm1.dat \
				-A P 
