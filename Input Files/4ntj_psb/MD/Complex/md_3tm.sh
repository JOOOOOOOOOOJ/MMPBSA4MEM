...
#cd $wrk
#
${pmemd_mpi} -O -i 01_Min.in -p 4ntj_psb.prmtop -c 4ntj_psb.inpcrd -o 01_Min.out -r 01_Min.rst -x 01_Min.crd -ref 4ntj_psb.inpcrd

echo "ending 1min"

echo "starting 2mdheat"

${pmemd} -O -i 02_Heat.in -p 4ntj_psb.prmtop -c 01_Min.rst -o 02_Heat.out -r 02_Heat.rst -x 02_Heat.crd -ref 01_Min.rst

echo "ending 2mdheat"

echo "starting 3mdhold"

${pmemd} -O -i 03_Hold.in -p 4ntj_psb.prmtop -c 02_Heat.rst -o 03_Hold.out -r 03_Hold.rst -x 03_Hold.crd -ref 02_Heat.rst

echo "ending 3mdhold"

echo "starting 4mdhold"

${pmemd} -O -i 04_Hold.in -p 4ntj_psb.prmtop -c 03_Hold.rst -o 04_Hold.out -r 04_Hold.rst -x 04_Hold.crd

echo "ending 4mdhold"

echo "starting 5mdprod"

${pmemd} -O -i 05_Prod.in -p 4ntj_psb.prmtop -c 04_Hold.rst -o 05_Prod.out -r 05_Prod.rst -x 05_Prod.crd
